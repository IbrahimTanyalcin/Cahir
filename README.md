...
*[Cahir](dist/cahir.0.1.1.evergreen.umd.js) is a function proxy that allows you interchangibly use tagged templates and method calls. You can use it as an imperative framework with declerative bits. You define the routines and you define the shortcuts.*
...
- Use cahir to enable your custom function to interoperate with tagged templates and method calls? here 👉 [dist](dist/cahir.0.1.1.evergreen.es.js) *read below to see how it works*
...
for components
```html
<script type="module" src="./components/simpleChat/simple-chat.0.1.1.es.js"></script>
```

or for DOM library only
```html
<script type="module" src="./collections/DOM/ch.0.1.1.es.js"></script>
```

or for just Cahir to construct your own method chaining/tagged template library
```html
<script type="module" src="./dist/cahir.0.1.1.evergreen.es.js"></script>
```
